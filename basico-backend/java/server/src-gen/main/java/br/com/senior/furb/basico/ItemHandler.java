...
import static br.com.senior.furb.basico.ItemEntity.SECURITY_RESOURCE;
...
import br.com.senior.furb.basico.Item.Id;
import br.com.senior.furb.basico.Item.PageRequest;
import br.com.senior.furb.basico.Item.PagedResults;
import br.com.senior.furb.basico.BasicoConstants;
import br.com.senior.furb.basico.CreateItem;
import br.com.senior.furb.basico.UpdateItem;
import br.com.senior.furb.basico.DeleteItem;
import br.com.senior.furb.basico.RetrieveItem;
import br.com.senior.furb.basico.ListItem;
...
import br.com.senior.furb.basico.ItemDTOConverter;
import br.com.senior.platform.translationhub.api.TranslationHubApi;

@HandlerImpl(serviceClass = BasicoConstants.class)
@Component("furb.basico.ItemHandler")
public class ItemHandler implements CreateItem, CreateMergeItem, UpdateItem, DeleteItem, 
	...
	private ItemEntity doUpdate(Item toUpdate) {
		...
		if(entity == null)
			throw new ServiceException(ErrorCategory.OBJECT_NOT_FOUND, translationHubApi.getString("br.com.senior.furb.basico.Item_notFound", "Item not found with id " + toUpdate.id));
