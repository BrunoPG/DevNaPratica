...
public class ExportSalaOutput {
    
    public String exportJobId;
    
    public ExportSalaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportSalaOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportSalaOutput)) {
            return false;
        }
        ExportSalaOutput other = (ExportSalaOutput) obj;
