...
public class ImportTipoImpl {
	...
	public ImportTipoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportTipoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_TIPO, //
	...
	*/
	public ImportTipoOutput importTipo(ImportTipoInput input, long timeout) {
		...
		ImportTipoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportTipoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportTipoOutput> importTipoRequest(ImportTipoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportTipoOutput.class);
	}
