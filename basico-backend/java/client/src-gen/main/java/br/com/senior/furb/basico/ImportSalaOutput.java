...
public class ImportSalaOutput {
    
    public String importJobId;
    
    public ImportSalaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportSalaOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportSalaOutput)) {
            return false;
        }
        ImportSalaOutput other = (ImportSalaOutput) obj;
