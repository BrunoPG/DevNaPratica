 ...
 * 
 */
public class CreateMergeEventoImpl {
	...
	public CreateMergeEventoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Evento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.CREATE_MERGE_EVENTO, //
