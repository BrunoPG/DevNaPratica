 ...
 * 
 */
public class CreateBulkSetorImpl {
	...
	public CreateBulkSetorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkSetorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_SETOR, //
	...
	*/
	public CreateBulkSetorOutput createBulkSetor(CreateBulkSetorInput input, long timeout) {
		...
		CreateBulkSetorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkSetorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkSetorOutput> createBulkSetorRequest(CreateBulkSetorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkSetorOutput.class);
	}
