 ...
 * 
 */
public class CreateBulkTipoImpl {
	...
	public CreateBulkTipoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkTipoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_TIPO, //
	...
	*/
	public CreateBulkTipoOutput createBulkTipo(CreateBulkTipoInput input, long timeout) {
		...
		CreateBulkTipoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkTipoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkTipoOutput> createBulkTipoRequest(CreateBulkTipoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkTipoOutput.class);
	}
