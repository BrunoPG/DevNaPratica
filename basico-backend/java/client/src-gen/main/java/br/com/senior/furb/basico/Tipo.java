...
public class Tipo {
    ...
    public static class PagedResults {
        ...
        public List<Tipo> contents;
        
        public PagedResults() {
        }
        
        public PagedResults(List<Tipo> contents) {
            this.contents = contents;
        }
        
        public PagedResults(List<Tipo> contents, Long totalPages, Long totalElements) {
            this.contents = contents;
     ...
     */
    public Tipo(String id, String nome, String descricao) {
        this.id = id;
        this.nome = nome;
    ...
    void toString(StringBuilder sb, List<Object> appended) {
    	...
    	sb.append("descricao=").append(descricao == null ? "null" : descricao);
    	sb.append(']');
    }
