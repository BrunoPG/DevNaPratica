...
public class ImportTipoOutput {
    
    public String importJobId;
    
    public ImportTipoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportTipoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportTipoOutput)) {
            return false;
        }
        ImportTipoOutput other = (ImportTipoOutput) obj;
