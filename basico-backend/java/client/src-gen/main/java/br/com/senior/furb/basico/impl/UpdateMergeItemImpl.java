 ...
 * 
 */
public class UpdateMergeItemImpl {
	...
	public UpdateMergeItemImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Item input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.UPDATE_MERGE_ITEM, //
