...
public class Pedido {
     ...
     * Itens do pedido
     */
    public java.util.List<Item> itens;
     ...
     */
    public Pedido(String id, java.time.LocalDate data, String obsservacoes, Cliente cliente, java.util.List<Item> itens) {
        this.id = id;
        this.data = data;
     ...
     */
    public Pedido(java.time.LocalDate data, Cliente cliente, java.util.List<Item> itens) {
        this.data = data;
        this.cliente = cliente;
        this.itens = itens;
    }
