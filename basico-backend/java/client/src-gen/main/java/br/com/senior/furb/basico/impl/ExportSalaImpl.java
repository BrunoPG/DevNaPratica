...
public class ExportSalaImpl {
	...
	public ExportSalaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportSalaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_SALA, //
	...
	*/
	public ExportSalaOutput exportSala(ExportSalaInput input, long timeout) {
		...
		ExportSalaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportSalaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportSalaOutput> exportSalaRequest(ExportSalaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportSalaOutput.class);
	}
