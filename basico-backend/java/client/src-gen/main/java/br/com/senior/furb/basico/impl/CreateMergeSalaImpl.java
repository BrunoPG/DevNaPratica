 ...
 * 
 */
public class CreateMergeSalaImpl {
	...
	public CreateMergeSalaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Sala input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.CREATE_MERGE_SALA, //
