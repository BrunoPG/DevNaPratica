...
public class ImportSetorOutput {
    
    public String importJobId;
    
    public ImportSetorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportSetorOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportSetorOutput)) {
            return false;
        }
        ImportSetorOutput other = (ImportSetorOutput) obj;
