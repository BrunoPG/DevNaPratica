...
public class ExportEventoOutput {
    
    public String exportJobId;
    
    public ExportEventoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportEventoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportEventoOutput)) {
            return false;
        }
        ExportEventoOutput other = (ExportEventoOutput) obj;
