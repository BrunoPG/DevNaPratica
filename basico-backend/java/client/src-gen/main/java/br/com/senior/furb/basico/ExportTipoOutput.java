...
public class ExportTipoOutput {
    
    public String exportJobId;
    
    public ExportTipoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportTipoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportTipoOutput)) {
            return false;
        }
        ExportTipoOutput other = (ExportTipoOutput) obj;
