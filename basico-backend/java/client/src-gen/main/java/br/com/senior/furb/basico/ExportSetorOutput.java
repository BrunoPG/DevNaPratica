...
public class ExportSetorOutput {
    
    public String exportJobId;
    
    public ExportSetorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportSetorOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportSetorOutput)) {
            return false;
        }
        ExportSetorOutput other = (ExportSetorOutput) obj;
