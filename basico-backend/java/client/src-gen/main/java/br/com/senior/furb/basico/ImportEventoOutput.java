...
public class ImportEventoOutput {
    
    public String importJobId;
    
    public ImportEventoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportEventoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportEventoOutput)) {
            return false;
        }
        ImportEventoOutput other = (ImportEventoOutput) obj;
