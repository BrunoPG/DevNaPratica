 ...
 * 
 */
public class CreateBulkSalaImpl {
	...
	public CreateBulkSalaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkSalaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_SALA, //
	...
	*/
	public CreateBulkSalaOutput createBulkSala(CreateBulkSalaInput input, long timeout) {
		...
		CreateBulkSalaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkSalaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkSalaOutput> createBulkSalaRequest(CreateBulkSalaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkSalaOutput.class);
	}
